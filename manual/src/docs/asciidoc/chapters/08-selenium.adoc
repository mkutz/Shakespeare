...
The screenshots can then be found at the configured reports path and are named `<counter>-<actor>-<reportType>-<task|question>.png`, e.g. `001-imogen-success-latest_shakespeare_release_version.png`.
