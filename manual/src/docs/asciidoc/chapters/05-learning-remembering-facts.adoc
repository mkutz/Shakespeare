...
----
include::../../../test/java/FactDocTest.java[tag=learn-fact]

include::../../../test/java/FactDocTest.java[tag=remember-fact]
----
...
[source,java,indent=0]
----
include::../../../test/java/FactDocTest.java[tag=fact]
----
...
include::../../../test/java/FactDocTest.java[tag=relearn-fact]

include::../../../test/java/FactDocTest.java[tag=remember-changed-fact]
----
...
[source,java,indent=0]
----
include::../../../test/java/FactDocTest.java[tag=poly-fact]
----

.Learn and remember Poly Facts
[source,java,indent=0]
----
include::../../../test/java/FactDocTest.java[tag=learn-poly-fact]

include::../../../test/java/FactDocTest.java[tag=remember-poly-fact]
----
...
[source,java,indent=0]
----
include::../../../test/java/FactDocTest.java[tag=fact-with-default]
----
...
[source,java,indent=0]
----
include::../../../test/java/FactDocTest.java[tag=fact-with-generator]
----
