...
class FactDocTest {
    ...
    void act1() {
        ...
        // end::remember-fact[]
        assertThat(katesPhoneNumber)
                .isInstanceOf(PhoneNumber.class);
        // tag::relearn-fact[]
        ...
        assertThat(katesNewPhoneNumber)
                .isEqualTo(new PhoneNumber("+1 (303) 499-7111"));
    ...
    void act2() {
        ...
        assertThat(robinsPhoneNumbers)
                .isInstanceOf(PhoneNumbers.class);
    }
    ...
    void act3() {
        ...
        assertThat(bill.remembers(CreditCard.class))
                .isEqualTo(CreditCard.DEFAULT_VISA);
