...
class HtmlSnapshotReporterTest {
  ...
  Actor tim =
      new Actor("Tim")
          .can(
              new BrowseTheWeb(
                  new StaticWebDriverSupplier(new NullWebDriver(), BrowserType.FIREFOX, null)));
  ...
  void test3() {
    ...
    assertThat(reportsPath)
        .isDirectoryContaining(
            "glob:build/reports/shakespeare/001-tim-retry-retryable_test_task.html")
        .isDirectoryContaining(
            "glob:build/reports/shakespeare/002-tim-retry-retryable_test_question.html")
        .isDirectoryContaining(
            "glob:build/reports/shakespeare/003-tim-retry-retryable_test_question.html");
  }
