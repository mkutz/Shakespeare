...
class ScreenshotReporterTest {
    ...
    Actor imogen = new Actor("Imogen")
            .can(new BrowseTheWeb(new StaticWebDriverSupplier(new NullWebDriver(), BrowserType.CHROME, null)));
    ...
    void test3() {
        ...
        assertThat(reportsPath)
                .isDirectoryContaining("glob:build/reports/shakespeare/001-imogen-retry-retryable_test_task.png")
                .isDirectoryContaining("glob:build/reports/shakespeare/002-imogen-retry-retryable_test_question.png")
                .isDirectoryContaining("glob:build/reports/shakespeare/003-imogen-retry-retryable_test_question.png");
    }
    ...
    void test4() {
        ...
        assertThat(reportsPath)
                ...
                .isDirectoryContaining("glob:build/reports/shakespeare/002-imogen-failure-test_question.png")
                .isDirectoryContaining("glob:build/reports/shakespeare/003-imogen-failure-test_question.png");
    }
}
