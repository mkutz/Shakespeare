...
/**
 * Reporter using the {@link Actor}'s {@link BrowseTheWeb#getWebDriver()} as {@link TakesScreenshot} to take a
 * screenshot of the currently displayed site. By default, only retries and failures are reported. If
 * {@link #reportSuccess} is set true, successes are reported as well.
 */
