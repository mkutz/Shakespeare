...
/**
 * A {@link WebDriverSupplier} for Docker based browser instances. Uses {@link WebDriverManager} to
 * manage the container and create the {@link WebDriver}.
 */
public class DockerWebDriverSupplier extends WebDriverManagerWebDriverSupplier {
  ...
  public DockerWebDriverSupplier(BrowserType browserType, Capabilities additionalCapabilities) {
    super(
        WebDriverManager.getInstance(browserType.getWebDriverClass()).browserInDocker(),
        browserType,
